...
if GoRepair == 1 | GoRepair == 2
    ...
    figname1 = ['artglobal', up1name, imagfold, '.png'];
    figname2 = ['artglobal', up1name, imagfold, '.fig'];
    temp = pwd;
    cd(subjectpath);
    try
        saveas(gcf,figname1);
