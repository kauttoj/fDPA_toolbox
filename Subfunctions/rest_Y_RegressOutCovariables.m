function [] = rest_Y_RegressOutCovariables(ADataDir,ACovariablesDef,APostfix)
...
% Written by YAN Chao-Gan 080610.  Referenced from REST fc.m.
...
for x=1:sampleLength,
    ...
    rest_writefile(AllVolume(:, :, :, x), ...
        ...
        [nDim1,nDim2,nDim3],VoxelSize, Header,'float32');
