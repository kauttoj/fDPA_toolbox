...
[Situation1Volume,VoxelSize,theImgFileList, Header] =rest_to4d(DependentDirs{1});
fprintf('\n\tImage Files in Situation 1:\n');
for itheImgFileList=1:length(theImgFileList)
    fprintf('\t%s%s\n',theImgFileList{itheImgFileList},'.img');
end
[Situation2Volume,VoxelSize,theImgFileList, Header] =rest_to4d(DependentDirs{2});
fprintf('\n\tImage Files in Situation 2:\n');
for itheImgFileList=1:length(theImgFileList)
    fprintf('\t%s%s\n',theImgFileList{itheImgFileList},'.img');
end
