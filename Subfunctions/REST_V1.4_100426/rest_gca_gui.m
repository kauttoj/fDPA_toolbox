...
% Last revised by YAN Chao-Gan 100130, fixed the bug in ROI-wise GCA calculation.
		...
		try
			...
			for x=1:size(handles.Cfg.DataDirs, 1)	
                ...
                if get(handles.rbtnResidual,'Value')==1,
                    [ResultMap1,ResultMap2] = rest_gca_residual( handles.Cfg.DataDirs{x, 1}, ...
								handles.Cfg.MaskFile, ...
								Subject_ROIList, ...            
								theDstFile, ...
								Subject_Covariables, ...
                    ...
                    [ResultMap1,ResultMap2] = rest_gca_coefficient( handles.Cfg.DataDirs{x, 1}, ...
								handles.Cfg.MaskFile, ...
								Subject_ROIList, ...            
								theDstFile, ...
								Subject_Covariables, ...
...
function InitFrames(hObject,handles)
	...
	uicontrol(handles.figGCAMain,'Style','Text','Position',[208 offsetY+222 40 14],...
		'String','Mask');		
